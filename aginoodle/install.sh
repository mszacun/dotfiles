...
wget https://archive.archlinux.org/packages/p/php/php-5.6.9-2-x86_64.pkg.tar.xz
sudo pacman -U php-5.6.9-2-x86_64.pkg.tar.xz
read -p "Uncomment mysql libraries in php.ini [Enter]"
php -t ~/teamcal -S 127.0.0.1:4000&
sleep 2
