...
_managepy-commands() {
  ...
  commands=(
    ...
    'compareteammemberswithteamcal:Compares team members in teamcal and in database, sends email when someone is only in teamcal'
    'countteamstatusesinsprint:Counts number of status team had in given sprint'
    'dbshell:Runs the command-line client for the current DATABASE_ENGINE.'
    'detectcommitment:Calculate teams velocity for past sprints'
    "diffsettings:Displays differences between the current settings.py and Django's default settings."
    'dumpdata:Output the contents of the database as a fixture of the given format.'
    'fbpupdate:Update feature build plan from xlsb file'
    'findlastsprintitemsversions:Finds last items versions in sprint'
    ...
    'refreshcapacity:Refresh capacity for all teams and sprints in database'
    'refreshteammembers:Refresh team members from teamcal'
    'refreshuserspersonaldata:Refresh users first name and last name using LDAP'
    'runfcgi:Run this project as a fastcgi (or some other protocol supported by flup) application,'
    'runserver:Starts a lightweight Web server for development.'
    'sendgtmails:Unsubscribe previous green teams from component mails, subscribe current green teams to component mails'
    ...
    'togglewarningmessageflag:Toggle warning message flag for displaying modal with update information'
