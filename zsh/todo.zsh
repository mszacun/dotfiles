...
alias taf="TODOTXT_PRIORITY_ON_ADD=F TODO_DIR=$GLOBAL_TODO_DIR todo-git-wrapper -t add"
alias tag="TODOTXT_PRIORITY_ON_ADD=G TODO_DIR=$GLOBAL_TODO_DIR todo-git-wrapper -t add"
...
alias trm="TODO_DIR=$GLOBAL_TODO_DIR todo-git-wrapper rm"
alias tggu="TODO_DIR=$GLOBAL_TODO_DIR todo-git-wrapper git pull --rebase"
alias tggp="TODO_DIR=$GLOBAL_TODO_DIR todo-git-wrapper git push"


alias lt="TODO_DIR=./todo/ todo.sh -t"
alias lta="TODO_DIR=./todo/ todo.sh -t add"
alias ltaa="TODOTXT_PRIORITY_ON_ADD=A TODO_DIR=./todo/ todo.sh -t add"
alias ltab="TODOTXT_PRIORITY_ON_ADD=B TODO_DIR=./todo/ todo.sh -t add"
