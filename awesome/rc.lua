...
theme.bg_focus      = "#5F93A8"
theme.border_width  = 3
theme.border_normal = "#323A45"
theme.border_focus  = "#5F93A8"
theme.wallpaper = "/home/szacun/images/abstract_polygons.jpg"

-- This is used later as the default terminal and editor to run.
terminal = "xfce4-terminal --geometry=100x50"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "Next",  function () awful.client.moveresize( 0,  0, -1, -1) end),  
    awful.key({ modkey, "Control" }, "Prior", function () awful.client.moveresize( 0, 0,  1,  1) end),  
